  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden" aria-hidden="true">
        <img src="/warehouse-bg.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex flex-col justify-end w-full p-12">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-sm">
            {[{ label: 'Bodegas', value: '—' }, { label: 'Productos', value: '—' }, { label: 'Movimientos hoy', value: '—' }].map((stat) => (
              <div key={stat.label} className="bg-surface/70 backdrop-blur-sm border border-border rounded-lg px-4 py-3">
