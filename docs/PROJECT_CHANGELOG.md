...
- Se corrigio la condicion de carrera al soltar una seccion durante su arrastre, que podia intentar leer una referencia ya liberada y cerrar la pagina. La bodega virtual `BG-PROD` se conserva en datos, pero deja de mostrarse en el mapa hasta que exista un flujo operativo WIP.
